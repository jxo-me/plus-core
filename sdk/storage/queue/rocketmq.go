...
func (r *RocketMQ) Append(ctx context.Context, message storage.Messager) error {
...
func (r *RocketMQ) Register(ctx context.Context, name string, f storage.ConsumerFunc) {
